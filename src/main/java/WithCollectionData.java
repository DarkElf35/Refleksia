...
public class WithCollectionData extends WithArrayData {
    ...
    public WithCollectionData(int intData, byte byteData, String objectData, String stringData, String[] stringArray, List<String> listString, Map<String,SimpleData> mapStringSimpleData) {
    }
